...
int main() {
    ...
    Vector<double> vect_list[] = {e1, e2, e3};
    double           coef1[] = {10., -2., 0.5};
    std::cout   << "e1 =\n" << e1 << std::endl
                << "e2 =\n" << e2  << std::endl
                << "e3 =\n" << e3 << std::endl
                << "coef1 = [10.  -2.  0.5]" << std::endl << std::endl;
    Vector<double> res = linear_combination< Vector<double>, double >(vect_list, coef1, 3);
    std::cout << "linear_combination([e1, e2, e3], coef1) =\n" << res;

    std::cout << "----\n\n";
    Vector<double> v1 = {1., 2., 3.};
    Vector<double> v2 = {0., 10., -100.};
    Vector<double> vect_list2[] = {v1, v2};
    double           coef2[] = {10., -2};
    std::cout   << "v1 =\n" << v1 << std::endl
                << "v2 =\n" << v2  << std::endl
                << "coef2 = [10.  -2]" << std::endl << std::endl;
    Vector<double> res2 = linear_combination< Vector<double>, double >(vect_list2, coef2, 2);
